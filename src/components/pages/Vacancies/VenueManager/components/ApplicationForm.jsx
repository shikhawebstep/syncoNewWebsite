...
const validateStep1 = (data) => {
  ...
  if (!data.age.trim()) {
    ...
    errors.age = "Enter a valid age (16–80).";
  }
...
const validateStep2 = (data) => {
  ...
  if (!data.coachingExperience)
    errors.coachingExperience = "Please select coaching experience.";
  if (data.ageGroups.length === 0)
    errors.ageGroups = "Please select at least one age group.";
  if (!data.managementExperience)
    errors.managementExperience = "Please select management experience.";
  return errors;
};
...
const ApplicationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      fd.append("accessToOwnVehicle", formData.hasVehicle === "Yes" ? "true" : "false");
      fd.append("whichQualificationYouHave", JSON.stringify(formData.qualifications));
      fd.append("footballExperience", formData.coachingExperience);
      fd.append("managementExperience", formData.managementExperience);
      ...
      const response = await fetch(
        "https://api.grabbite.com/api/open/recruitment/venue-manager/candidate-profile",
      ...
      setErrors({});
      setStep(1);
      addToast("Your application has been submitted successfully! We'll be in touch soon.", "success");
    } catch (error) {
      ...
      >
        ...
        <div className="flex gap-8 mb-8">
          {[1, 2, 3].map((s) => (
            <button
              ...
              type="button"
              onClick={() => goToStep(s)}
              className={`pb-3 md:text-[22px] text-[17px] recline font-medium ${step === s
          ...
          <div className="space-y-5">
            ...
            <div>
              <p className="label mb-3">
                Do you have access to your own vehicle? <RequiredStar />
              </p>
          ...
          <div className="space-y-8">
            ...
            <div>
              <p className="text-[16px] text-[#101014] font-normal mb-4">
                Please select which qualifications you have <RequiredStar />
              </p>
            ...
            <div className="mb-6">
              <p className="label text-[16px] text-[#101014] font-normal mb-3">
                How many years football coaching experience do you have? <RequiredStar />
              </p>
              <div className="relative w-full">
                <select
                  ...
                  disabled={isSubmitting}
                  className={`w-full appearance-none rounded-lg border-2 px-4 py-3 pr-12 bg-white focus:outline-none focus:border-[#1c3c87] ${errors.coachingExperience ? "border-red-400" : "border-[#E5E7EB]"
              ...
              <ErrorMsg name="coachingExperience" />
            </div>

            {/* Age Groups */}
            <div>
              <p className="text-[16px] text-[#101014] font-normal mb-4">
                Which age groups do you have experience working with? <RequiredStar />
              </p>
            ...
            <div className="mb-6">
              <p className="label text-[16px] text-[#101014] font-normal mb-3">
                How many years of management experience do you have? <RequiredStar />
              </p>
              <div className="relative w-full">
                <select
                  ...
                  onChange={handleChange}
                  disabled={isSubmitting}
                  className={`w-full appearance-none rounded-lg border-2 px-4 py-3 pr-12 bg-white focus:outline-none focus:border-[#1c3c87] ${errors.managementExperience ? "border-red-400" : "border-[#E5E7EB]"
              ...
              <ErrorMsg name="managementExperience" />
            </div>
        ...
        {step === 3 && (
          <div className="space-y-8">
            ...
            <div>
              <p className="label mb-3">
                Do you have full time weekend availability? <span className="text-red-500">*</span>
              </p>
              <div className="flex gap-5">
                {["Yes", "No"].map((v) => (
                  <label key={v} className="flex custom-radio text-[#5F5F6D] items-center gap-3 mb-2">
            ...
            <div className="w-full">
              <label className="label text-[16px] text-[#101014] font-normal">
                Please upload your CV <span className="text-red-500">*</span>
              </label>
              <div
            ...
            <div>
              ...
              <div className="flex justify-between items-center mt-1">
                ...
                <span className="text-xs text-gray-400 ml-auto">
                  {formData.coverNote.trim() ? formData.coverNote.trim().split(/\s+/).length : 0} / 500 words
                </span>
              </div>
            </div>
