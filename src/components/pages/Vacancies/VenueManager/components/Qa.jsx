  ...
  return (
    <section className="bg-white py-20 px-5 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
        ...
        {/* LEFT CONTENT */}
        <div>
          <h2 className="text-[38px] lg:text-[48px] leading-tight recline font-bold text-[#042C89]">
            If you think you <br className="block md:hidden"  /> have <br className="md:block hidden" />
            what it takes, we’d love <br className="md:block hidden"  />
            to hear <br className="block md:hidden"  />  from you!
          </h2>
        </div>
        ...
        <div>
          ...
          <ul style={{paddingLeft:'30px'}} className="space-y-0 list-disc  grid gap-2 text-[#5F5F6D] text-[18px]">
      ...
      <div className="mb-6 border-[9px] max-w-[994px] m-auto border-white overflow-hidden rounded-4xl bg-gray-200">
        ...
        <div className="relative aspect-[16/4]  h-[500px]  w-full">
          <iframe
            ...
            style={{ border: 0 , borderRadius: '22px',height:'100%'}}
            allowFullScreen
          />
        </div>
      </div>
      ...
      <div className="text-center mt-16">
        <p className="text-[#0DD180] md:text-[40px] text-[34px] permanent-marker font-medium tracking-wide uppercase">
          So what are you waiting for?
        </p>

        <p className="text-[#797A88] poppins md:text-[20px] mt-2">
          If you believe you’d be a good fit for the role and would relish <br className="md:block hidden" />
