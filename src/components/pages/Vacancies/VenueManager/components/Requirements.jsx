...
const Requirements = () => {
  return (
    <section
      className="relative bg-cover bg-center py-[250px]"
      ...
      <div className="relative z-999 mx-auto px-5">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-[1100px] mx-auto">
          ...
          <div className="bg-white rounded-[28px] p-10 shadow-lg">
            <h2
              className="text-[48px] permanent-marker text-[#00A6E3] mb-6"
            
            >
              Requirements
            </h2>

            <p className="text-[#797A88] text-[16px] leading-[26px] mb-6">
            ...
            <span
              className="text-[22px] recline text-[#042C89] mb-4"
            >
