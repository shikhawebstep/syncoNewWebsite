...
const Banner = () => {
    return (
        <section
            className="relative BecomeACoachBannerSection flex bg-cover items-end bg-[#0DD180]  bg-top pt-[150px] pb-[150px] md:min-h-[800px] min-h-[1300px]"
        
        >
            <div className="container mx-auto ">
                <div className="text-center max-w-[850px]  md:mt-0 mt-[-600px] mx-auto">
                    <h1 className=" leading-tight recline lg:text-[64px] text-[48px] text-white font-medium">
