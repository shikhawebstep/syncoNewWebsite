...
const HowWork = () => {
  return (
    ...
    ><div className="container">
        <div className='max-w-10/12 m-auto bg-[#FDFDFF] p-8 rounded-3xl'>

          <h4 className="text-[#042C89] recline text-center">How does the programme work?</h4>
          <p className='text-[#042C89]  text-[20px] text-center'>Here are the details of our Coaching Pathway course</p>
          <div className=" rounded-[40px]  pt-8  p-7 ">

            {/* Inputs */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6 items-start text-[16px] leading-[26px] text-[#34353]">
