...
const BenifitSection = () => {
  ...
  return (
    <section
      className="bg-white"
    >
      <div className="bg-cover bg-white md:pt-[200px] pt-[100px] md:mt-0 mt-10 bg-white pb-[90px] relative"
      style={{ backgroundImage: `url(${bg})` }}>
      <div className="container mx-auto">
        {/* Heading */}
        <div className="text-center max-w-[1130px] mx-auto mb-14">
          <h2 className="text-white md:text-[50px] text-[40px] font-semibold recline leading-tight">
            What are the{" "}
        ...
        {/* Benefits Grid */}
        <div className="grid max-w-[1246px] m-auto grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 text-center">
          {/* Card 1 */}
          <div className="bg-[#fefefe08] md:bg-[#28478d]  md:flex items-center rounded-[20px] p-6">
            <div className="h-[190px] md:w-5/12 flex items-center md:justify-center mb-4">
            ...
            <div className="md:w-7/12">
              ...
              <p className="text-white text-[14px] md:max-w-[300px] text-left leading-relaxed">
...
Is there anything better than waking up in the morning and going to a job that you adore? For those who live and breathe football, coaching allows you to earn a living doing what you truly love. Upon completion of the course, we’ll direct you towards your FA qualifications or a Sports Apprenticeship, and the very best will be offered a job right there and then with Samba Soccer Schools and/or other partner clubs.               </p>
          ...
          </div><div className="bg-[#fefefe08] md:bg-[#28478d]  md:flex items-center rounded-[20px] p-6">
            <div className="h-[190px] md:w-5/12 flex items-center md:justify-center mb-4">
