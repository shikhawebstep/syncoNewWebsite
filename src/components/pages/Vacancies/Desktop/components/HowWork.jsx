...
const HowWork = () => {
    return (
        ...
        ><div className="container">
                <div className='md:max-w-10/12 m-auto coacingSessions bg-[#FDFDFF] p-8 rounded-3xl'>

                    <h4 className="text-[#042C89] md:text-[48px] text-[20px]  recline md:text-center">How does the programme work?</h4>
                    <p className='text-[#042C89] font-semibold  md:text-[20px] text-[16px] md:text-center'>Here are the details of our Coaching Pathway course</p>
