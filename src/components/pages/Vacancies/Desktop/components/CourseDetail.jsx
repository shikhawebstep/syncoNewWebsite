...
const CourseDetail = () => {
    ...
    return (
        ...
        >
            <div className="z-999 text-center relative">
                ...
                <div className="bg-white  p-5 mt-15 block mx-10 text-left text-[16px] w-fit m-auto     text-[#34353B]
 poppins mb-10 rounded-[20px] 
shadow-[0_25px_60px_-10px_rgba(0,0,0,0.35)]">
                    <p className="font-bold text-[#00A6E3] whitespace-nowrap mb-4">
                        Course dates:
                    </p>

                    <div className="space-y-4">
                        <p className="md:block flex gap-2">
                            <span className="font-bold text-[#00A6E3] whitespace-nowrap pr-1">Course 1:</span>{"  "}
                            Tuesday 12th – Tuesday 17th October (6 weeks)
                        </p>

                        <p className="md:block flex gap-2">
                            <span className="font-bold text-[#00A6E3] whitespace-nowrap pr-1">Course 2:</span>{"  "}
                            Tuesday 31st October – Tuesday 5th December (6 weeks)
                        </p>

                        <p className="md:block flex gap-2">
                            <span className="font-bold text-[#00A6E3] whitespace-nowrap pr-1">Course 3:</span>{"  "}
                            Tuesday 9th Jan – Tuesday 13th Feb (6 weeks)
                        </p>

                        <p className="md:block flex gap-2">
                            <span className="font-bold text-[#00A6E3] whitespace-nowrap pr-1">Course 4:</span>{"  "}
                            Tuesday 20th Feb – Tuesday 26th March (6 weeks)
                        </p>

                        <p className="md:block flex gap-2">
                            <span className="font-bold text-[#00A6E3] whitespace-nowrap pr-1">Course 5:</span>{"  "}
                            Tuesday 16th April – Tuesday 21st May (6 weeks)
                        </p>

                        <p className="md:block flex gap-2">
                            <span className="font-bold text-[#00A6E3] whitespace-nowrap pr-1">Course 6:</span>{"  "}
                            Tuesday 4th June – Tuesday 9th July (6 weeks)
                        </p>

                        <p className="md:block flex gap-2">
                            <span className="font-bold text-[#00A6E3] whitespace-nowrap pr-1">Course 7:</span>{"  "}
