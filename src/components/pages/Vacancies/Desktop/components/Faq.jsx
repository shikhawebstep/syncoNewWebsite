    ...
    return (
        <>
            <div className="lg:block gap-4 lg:max-w-[1100px] mt-5 m-auto lg:space-x-10">
                {/* Questions */}
                <div className="w-full md:max-w-[100%] max-w-[70%] m-auto flex flex-col md:flex-row justify-center items-center gap-4 md:gap-8 mb-6 ">
                ...
                px-4 py-3 text-[18px] md:text-[20px]
