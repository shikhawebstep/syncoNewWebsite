...
const WhyBrazil = () => {
    return (
        <section
             className="
              relative flex items-end bg-no-repeat bg-top bg-[#fff]
              md:pt-[350px] pt-[250px] pb-[120px]
              lg:pt-[550px] lg:pb-[200px] lg:min-h-[800px]
              bg-[url('/assets/whyBrazilMobile.png')]
              lg:bg-[url('/assets/whyBrazilBg.png')]
              bg-contain
            "
        >
            <div className="container mx-auto">
                {/* Heading */}
                <div>
                    <h2 className="text-left items-center flex gap-6 text-[#0DD180] text-[45px] md:text-[56px] font-normal permanent-marker mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-white text-[17px] mt-10 leading-relaxed">
                        ...
                        <div className="space-y-8">
                            <p className="font-light text-[#797A88] leading-8">
                        ...
                        <div className="space-y-8">
                            ...
                            <img src="/assets/img-what-is-brazilian-football-for-kids.png" className="w-11/12 m-auto mt-10" alt="" />

                        </div>
                    </div>
                </div>
                <div className="mt-10">
                    <h2 className="text-left items-center flex gap-6 text-[#00A6E3] text-[48px] md:text-[56px] font-normal permanent-marker mb-12">
                        Style of play<img src="/assets/football.png" alt="Brazil Flag" />
                    </h2>
                    <span className="text-[#797A88] text-[22px] recline font-bold italic">“Football is happiness. It's a dance. It's a true party,” - Pelé.</span>
                    {/* Content */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-white text-[17px] mt-10 leading-relaxed">
