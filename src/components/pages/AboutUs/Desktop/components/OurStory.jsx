...
const OurStorySection = () => {
  return (
    <>
    <img src="/assets/Vector2.png" alt="" className="block md:hidden" />
    <section className="story-banner relative bg-gradient-to-b from-[#0B2A6A] to-[#0E3B8C] bg-cover  md:py-24  px-5"
      style={{
      ...
      <div className="mx-auto max-w-5xl md:pt-30">
        {/* Heading */}
        <h2 className="md:text-center text-[#FFDE14] text-[48px] md:text-[56px] font-bold recline md:mb-10">
          Our Story
        </h2>

        {/* Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 md:gap-12 gap-6 text-white text-[17px] md:mt-10 max-w-[850px] m-auto leading-relaxed">

          {/* Left Column */}
          <div className="space-y-8">
            <p className="font-light text-[#FDFDFF] text-[15px] tracking-[0.2px] leading-8">
          ...
          <div className="space-y-8">
            ...
            <p className="font-light text-[#FDFDFF] text-[15px] tracking-[0.2px] leading-8 ">This is football as it’s supposed to be.
            </p>
            <div className="block md:hidden">
              <img
