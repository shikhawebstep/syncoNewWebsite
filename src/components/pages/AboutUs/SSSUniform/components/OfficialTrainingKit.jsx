        ...
        >
            <div className="container z-999 mx-auto">
                ...
                <div>
                    ...
                    <p className="text-[#5F5F6D] text-[20px] poppins md:text-center" >The items below are compulsory for students attending our classes.</p>
                    {/* Content */}
                    ...
                    <div className="border-3 mt-15  rounded-xl py-15 border-white bg-[#FDFDFF]  shadow-[0_-4px_12px_rgba(0,0,0,0.12)]">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 mt-10 leading-relaxed place-items-center">
