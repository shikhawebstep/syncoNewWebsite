...
const WhyBrazil = () => {
    return (
        <section
            className="relative  flex bg-contain bg-no-repeat items-end bg-[#fff]  bg-top pt-[550px] pb-[200px] lg:min-h-[800px]"
            style={{ backgroundImage: `url(${bannerImg})` }}
        >
            <div className="container mx-auto">
                {/* Heading */}
                <div>
                    <h2 className="text-left items-center flex gap-6 text-[#0DD180] text-[48px] md:text-[56px] font-normal permanent-marker mb-12">
