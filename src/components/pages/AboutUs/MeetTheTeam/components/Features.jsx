              ...
              {sections.map((section, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="md:w-5/12 p-15 relative">
                      <img
                        src={section.image}
                    ...
                    <div className="md:w-7/12 text-gray-700">
                      ...
                      <h1 className='text-[52px] w-full text-left recline blue-text'> <span className='text-[#0DD180] permanent-marker   ' >  {section.title1}</span>  {section.title2}
                      </h1>
