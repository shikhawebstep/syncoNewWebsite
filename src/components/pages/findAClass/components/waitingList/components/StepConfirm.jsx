        ...
        {isBooked ? (
          <>
            <button
              type="button"
              disabled
              className="px-4 py-2 rounded-lg bg-[#16C784] font-bold md:text-[14px] text-white text-[12px] cursor-not-allowed flex items-center justify-center gap-2 min-w-[160px] whitespace-nowrap"
            >
              ✓ Added
            </button>
            <button
          ...
          <motion.button
            ...
            className="px-4 py-2 rounded-lg bg-[#042C89] font-bold md:text-[14px] text-white hover:bg-blue-900 disabled:bg-gray-400 text-[12px] min-w-[160px] whitespace-nowrap"
          >
