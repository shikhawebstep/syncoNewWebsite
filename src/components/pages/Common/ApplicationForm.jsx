        ...
        return (
            ...
            {step === 3 && (
                <div className="space-y-8">
                    <div className="mb-2">
                        <p className="label text-[16px] text-[#101014] font-normal mb-3">
                            Please select which venues you are available for work
                        </p>
                        <div className="relative w-full">
                            <select
                                ...
                                className={`w-full appearance-none rounded-lg border-2 px-4 py-3 pr-12 bg-white
                ${formData.venues === "" ? "text-[#9CA3AF]" : "text-[#5F5F6D]"}
                border-[#E5E7EB] focus:outline-none focus:border-[#1c3c87]`}
                            >
                                <option value="" disabled>
                                    Select venue
                                ...
                                <option
                                    value="Kings Cross / SAT (11am-1pm)"
                                ...
                                <option
                                    value="SSDS Cross / SAT (11am-1pm)"
                                >
                                    SSDS Cross / SAT (11am-1pm)
                                </option>

                                <option
                                    value="Kishghfgngs Cross / SAT (11am-1pm)"
                                >
                                    Kishghfgngs Cross / SAT (11am-1pm)
                                </option>
                            </select>
                    ...
                    <div className="flex  flex-wrap gap-2 mt-0">
                        {formData.venues && (
                            <div className="mt-3">
                                <span className="flex w-fit items-center gap-2 bg-[#ECFDF3] text-[#027A48] font-semibold px-3 py-1 rounded-full text-sm">
                                    {formData.venues}
                                    <button
                                        type="button"
                                        onClick={() =>
                                            setFormData((prev) => ({ ...prev, venues: "" }))
                                        }
