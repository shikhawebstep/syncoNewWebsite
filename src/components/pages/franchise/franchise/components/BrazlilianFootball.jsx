...
const BrazlilianFootball = () => {
    return (
        <section className='pt-[40px] md:pb-[40px] pb-0 px-[20px] md:px-0'>
            <div className="container">
                <div className="flex flex-col-reverse md:flex-row items-center">
                    <div className="image-sec md:flex justify-center md:w-6/12">
                        <div className="playboy-img md:max-w-[550px]">
                            <img className='onlyDesktop' src="/assets/kidPlaying.png" alt="" />
                            <img  src="/assets/ricoriba.png" className="-mt-[40px] onlyMobile" alt="" />
                    ...
                    <div className="right-side-content md:w-6/12 max-w-[680px] text-left">
                        ...
                        <p className="text-[15px] text-[#5F5F6D] mt-3">
                        ...
                        <p className="text-[15px] text-[#5F5F6D] my-3">
                        ...
                        <ul className='grid gap-2'>
                            <li className="text-[#5F5F6D] flex gap-2 text-[15px] items-center">
                                <img className="w-3.5" src="/assets/greenCheck.png" alt="" />
                        ...
                        <button 
                            ...
                            className="bg-[#0DD180] text-white px-4 mt-4 p-2.5 text-[16px] poppins font-semibold rounded-full">
                            Apply Today
                        </button>
                    </div>
                </div>
