...
const SchoolOffersYou = () => {
    return (
        <section
            className="bg-white"
        >
            <div className="bg-cover bg-white md:pt-[120px] pt-[60px] bg-white pb-[90px] relative"
            >
                <div className="container mx-auto">
                    {/* Heading */}
                    <div className="text-center max-w-[1130px] mx-auto mb-14">
                        <h2 className="text-[#28478d] md:text-[64px] text-[42px] font-semibold recline leading-tight">
                        ...
                        <p className="text-[#797A88] text-[18px] max-w-[820px] mx-auto mt-4 leading-relaxed">
                            Our franchise opportunity is designed to provide you with the tools and the know-how to push you above your local competitors from the very start.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 text-center">
                        {/* Card 1 */}
                        <div className="bg-[#FDFDFF] shadow-xl  md:flex items-center rounded-xl p-6">
                            ...
                            <div className="md:w-7/12">
                                <p className="text-[#0DD180] text-[32px] text-left recline font-bold mb-3">
                                    Exclusive Territory
                                </p>
                                <p className="text-[#797A88] text-[16px] text-left leading-relaxed">
                        ...
                        </div><div className="bg-[#FDFDFF] shadow-xl  md:flex items-center rounded-xl p-6">
                            <div className="h-[190px] md:w-5/12 flex items-center justify-center mb-4">
