    ...
    <section className="grey-bg py-20 ">
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-[64px] font-bold recline text-[#0b3c8c]">
            Your next{" "}
            <span className="text-[#22c55e] permanent-marker font-normal">STEPS...</span>
          </h2>
          <p className="mt-4 text22 text-gray-600 leading-relaxed">
        ...
        {/* Steps Wrapper */}
        <div className="relative mt-24 mx-auto lg:max-w-[980px] pb-15">
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between mb-28">
            ...
            <div className="md:w-[40%] text-center order-3 md:order-1 mt-6 md:mt-0">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Simply fill out the short application form at the bottom of this
                page to let us know you're interested in our football coaching
                franchise, and we'll be in touch shortly.
              </p>
            </div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between mb-28">
            ...
            <div className="md:w-[40%] text-center order-3 md:order-1 mt-6 md:mt-0">
              ...
              <p className="mt-2 text-sm text-gray-600">
                Get to know the management team behind Samba Soccer Schools with a
                face-to-face meeting where we’ll be happy to discuss the
                franchise process.
              </p>
            </div>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="md:w-[40%] text-center order-3 md:order-3 mt-4 md:mt-0">
              ...
              <p className="mt-2 text-sm text-gray-600">
                ...
                while having the opportunity to speak to our coaches and
                operations manager.
              </p>
            </div>
