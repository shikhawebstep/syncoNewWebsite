...
const Banner = () => {
  return (
    <section
      className="relative  idealCandidate flex bg-cover items-center  bg-bottom py-[100px] md:min-h-[800px] min-h-[1000px]" 

    >
      <div className="container mx-auto">
        <div className="pb-20 flex md:justify-end justify-center md:mt-0 mt-[-300px] max-w-[1130px] ">
          <h1 className="recline  leading-tight text-white text-[60px] lg:text-[72px]">
      ...
      <div className="absolute w-[700px] bottom-[10%] left-10 hidden lg:block">
        <img src="/assets/idealCandidate.png" alt="" />
      </div>
       <div className="absolute w-fit bottom-[10%] left-0 lg:hidden block">
