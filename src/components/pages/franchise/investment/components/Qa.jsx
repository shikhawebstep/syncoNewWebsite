...
const Qa = () => {
    ...
    const faqData = [
        ...
        {
            title: "How much do I need as an operating budget to start with?",
            description:
    ...
    return (
        <section className="md:pb-16 py-8 md:pt-50">
            <div className="container mx-auto md:px-4">
                <div className="w-full flex justify-center py-16 md:px-4">
                    <div className="relative max-w-[890px] w-full bg-white rounded-2xl shadowBox md:p-10 p-6 pt-10">

                        <div className="absolute w-full md:-top-55 -top-35 left-1/2 -translate-x-1/2">
                            <div className="md:max-w-[300px] max-w-[200px] m-auto"><img src="/assets/qa.png" alt="" /></div>

                        </div>

                        <div className="space-y-10 text-center mt-0">
                            {faqData.map((item, index) => (
                                <div key={index}>
                                    ...
                                    <p className="text-[#5F5F6D] text-[15px] font-medium leading-relaxed whitespace-pre-line text-sm md:text-base">
                                        {item.description}
                                    </p>
                                </div>
                            ))}
