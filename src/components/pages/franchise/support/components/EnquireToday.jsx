            ...
            <div className="container">
                ...
                <div className='max-w-[915px] m-auto text-[##34353B] md:text-center'>
                    ...
                    <p className='small15 leading-[30px] text-[#34353B] py-8'>
                        We don’t simply sell a product and then step back into the shadows, leaving you scrambling to understand a business you’re entirely new to. We’re committed to providing the ideal launch platform to maximise your chances of quickly building a profitable and robust business while also establishing a learning and support network you can use as little or as much as you need in the future.
                    </p>
