        ...
        <section className='py-[60px] '>
            <div className="container mx-auto">
                <div className="md:flex relative lg:max-w-[1100px] m-auto justify-between">
                    <div className='px-4 md:px-0 order-1 lg:order-2 max-w-[704px] ms-auto'>
                        <h3 className="small glorytext blue-text">
                            Playing for glory with Samba Soccer FC
                        </h3>
                        <p className='text-[15px] md:text-[16px] text-[#5F5F6D] mt-6'>Are you looking for competitive football for your child? Think they’ve got what it takes to join one of the most exciting teams around?

                        </p>
                         <p className='text-[15px] md:text-[16px] text-[#5F5F6D] mt-6'>We’ve got 13 years' worth of experience in football coaching, so we thought we’d better put it all to good use. Samba Soccer FC is our very own football club, with Brazilian style running through its veins.
                        </p>
                        <p className='text-[15px] md:text-[16px] text-[#5F5F6D] mt-6'>
                        ...
                        <button 
                            ...
                            className="text-white p-2 px-6 mt-6 font-semibold rounded-full bg-[#042C89] poppins text-[16px] "
                        >
                            Book now
                        </button>
                    </div>
