                ...
                <div className="container mx-auto">
                    <div className="md:flex items-center justify-between gap-10 rounded-2xl bg-[#FDFDFF] p-10 max-w-[1190px] mx-auto">
                        <div className="text-left text-white  recline md:w-[67%]">
                            <h4 className='text-[#0DD180] text-[60px] pb-3  text-[#042C89] recline '>Book Your<span className="permanent-marker  text-[#0DD180]"> Holiday </span><br className='onlyDesktop' /><span className="permanent-marker  text-[#0DD180]">Football Camp</span>Today!</h4>
                            ...
                            <p className='text-[#042C89] recline text-[18px]'>Enter your postcode to find the nearest holiday camp to you.</p>
