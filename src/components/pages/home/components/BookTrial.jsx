...
const BookTrial = () => {
    return (
        <>
            <section className="book-trial py-8 md:py-10 lg:py-12 p-4">
                <div className="container">
                    <div className="bg-white rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 lg:max-w-[1210px] m-auto">
