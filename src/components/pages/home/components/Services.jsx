    ...
    const cardsData = [
        {
            ...
            contentClass: "pl-2 sm:pl-4 md:pl-6",
        },
        {
            id: 2,
            title: "Holiday",
        ...
        },
        {
            ...
            align: "justify-end items-center endtext",
            contentClass: "pl-4 sm:pl-6 md:pl-10 lg:pl-14",
        },
    ]
        ...
        <>
            <section className="services py-10">
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 service-card sm:grid-cols-2 gap-4 mt-8 md:mt-10 lg:mt-12 lg:max-w-[1310px] m-auto sm:px-0">
                        {cardsData.map((card) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        <div className={`mt-2 md:mt-4 w-full md:w-6/12 ${card.contentClass || ''}`}>
                                    ...
                                    >
                                        <p className="text-white text-center text-[13px] sm:text-[14px] md:text-[16px] lg:text-[18px]  mb-5 md:mb-4 leading-relaxed">
                                            {card.description}
                                        </p>
